...
&check; closed-form bounds and numerical bounds. The numerical bouond costs 2 minutes when n=100,000,000. For better efficiency (but less tighter bound), use large tolerance (e.g., tol=\delta/n) or small number of iterations (e.g., T=10) 
